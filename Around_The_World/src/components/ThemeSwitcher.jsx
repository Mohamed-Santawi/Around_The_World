...
export function ThemeSwitcher() {
  ...
  return (
    <div className="w-16 h-8 p-1 rounded-full bg-[#2e2f33] flex items-center justify-around ">
      <button
        className={`${activeState} ${theme === "light" ? "bg-white" : ""}`}
      ...
      <button
        className={`${activeState} ${theme === "dark" ? "bg-white" : ""}`}
